...
def main(args):
    ...
    print('Number of SV-Tacotron2 Parameters:', num_param)
        ...
        for i, batchs in enumerate(training_loader):
            for j, data_of_batch in enumerate(batchs):
                ...
                speaker_ids = torch.Tensor(
                    data_of_batch["speaker_id"]).unsqueeze(1).long().to(device)
                ...
                # Forward
                batch = character, input_lengths, mel_target, stop_target, output_lengths, speaker_ids
